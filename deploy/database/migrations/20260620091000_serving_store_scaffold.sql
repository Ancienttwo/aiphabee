...
create table if not exists aiphabee_core.serving_dataset (
...
create table if not exists aiphabee_core.serving_field (
  serving_field_id text primary key,
  serving_dataset_id text not null references aiphabee_core.serving_dataset(serving_dataset_id),
...
create table if not exists aiphabee_core.serving_snapshot (
...
create table if not exists aiphabee_core.serving_record (
  serving_record_id text primary key,
  serving_snapshot_id text not null references aiphabee_core.serving_snapshot(serving_snapshot_id),
...
create table if not exists aiphabee_governance.serving_store_contract (
...
insert into aiphabee_governance.serving_store_contract (
  contract_key,
  contract_version,
  status,
