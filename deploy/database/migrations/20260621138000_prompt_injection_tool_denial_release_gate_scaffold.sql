...
create table if not exists aiphabee_core.prompt_injection_tool_denial_release_gate (
...
create table if not exists aiphabee_governance.prompt_injection_tool_denial_release_gate_contract (
