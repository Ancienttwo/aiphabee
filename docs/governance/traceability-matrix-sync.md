...
- DAT rows covered by immutable raw snapshot, security master, financial facts/restatement, corporate action adjustment/parity, field rights runtime/readiness, methodology, and data correction notification evidence.
