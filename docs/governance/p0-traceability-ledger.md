...
| DAT-03 财务事实与重述 | AIP-P0-DAT-03 | Data Engineering | 0.2 / 1.1 | Restatement versioning tests | Sprint 1.1 exit: multiple disclosures are preserved | Design baseline complete; storage pending |
