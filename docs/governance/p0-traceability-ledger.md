...
| DAT-06 数据质量与隔离 | AIP-P0-DAT-06 | Data Engineering / Quality | 0.3 / 1.1 | Quality hold and serving isolation tests | Sprint 1.1 exit: severe anomalies do not enter Serving Store | Serving Store schema and read planner scaffolds complete; live quality-release isolation pending |
