...
- `platform.*`：`supabase/migrations/20260623010000_platform_umbrella_schema_foundation.sql`（product/product_environment/account/workspace/workspace_membership/workspace_product_access/entitlement_policy/workspace_entitlement + platform_audit.product_access_event）。
- `core.*`：`supabase/migrations/20260620085000_account_workspace_entitlement_scaffold.sql`（account/workspace/workspace_membership/subscription_plan/…）、`20260621100000_subscription_lifecycle_audit_scaffold.sql`。
