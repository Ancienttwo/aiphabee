...
|---|---|---|
| Binding manifest | `deploy/cloudflare/bindings.contract.json` | Lists Worker, Workflows, Queues, Cron, Durable Objects, R2, KV, D1 eval store, AI Gateway, and Hyperdrive |
...
- Planned only: Workflows, Queues, Cron, Durable Objects, R2, KV, D1 eval
  store, AI Gateway, Hyperdrive.
