...
| 1.2 | Tool Registry + 原子数据工具 + 证据/血缘 | 🟦 | 9 / 12 | ☐ |
...
- [ ] Sprint 1.2 的 shared Tool Registry scaffold 与 9 个 registered no-live handlers 已建立；durable Evidence/Lineage service、工具 JSON Schema 细化、每工具 golden fixtures、MCP protocol endpoint 尚未实现
