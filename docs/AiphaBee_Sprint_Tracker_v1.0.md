...
| 2.4 | 订阅计费 + Workflows 深度任务 + 提醒 + 数据更正 | 🟦 | 2 / 10 | ☐ |
...
- [ ] Sprint 2.4 已建立 ACC-03 subscription lifecycle audit scaffold 与 ACC-04 billing-to-usage-ledger reconciliation scaffold；真实 billing provider、invoice/proration/refund preview、subscription/audit/invoice live writes、live ledger reads、refund/overage rules、Workflows、提醒、数据更正、MCP revoke live enforcement 与 kill switch 尚未实现
