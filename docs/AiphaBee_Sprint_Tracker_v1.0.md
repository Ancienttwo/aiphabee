...
| 1.1 | 主真值源 + Data Access Gateway | 🟦 | 6 / 12 | ☐ |
...
- [ ] Sprint 1.1 的真实数据加载、真实 Serving Gateway、字段级权益、usage ledger、账户/Workspace/订阅模型尚未实现；财务事实与公司行动/复权 schema 已存在但尚未接入 partner rows / Serving reads / live adjustment engine
