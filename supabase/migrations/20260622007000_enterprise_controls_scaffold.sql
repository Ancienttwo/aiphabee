...
create table if not exists aiphabee_core.enterprise_seat_assignment (
...
create table if not exists aiphabee_core.enterprise_sso_config (
...
create table if not exists aiphabee_audit.enterprise_admin_event (
...
create table if not exists aiphabee_core.private_data_connector (
...
create table if not exists aiphabee_governance.enterprise_controls_contract (
