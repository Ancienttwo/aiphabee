...
create table if not exists core.mcp_target_clients_console_release_gate (
...
create table if not exists governance.mcp_target_clients_console_release_gate_contract (
