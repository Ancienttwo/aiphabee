...
create table if not exists core.compliance_ops_release_gate (
...
create table if not exists audit.compliance_ops_drill_event (
...
create table if not exists governance.compliance_ops_release_gate_contract (
