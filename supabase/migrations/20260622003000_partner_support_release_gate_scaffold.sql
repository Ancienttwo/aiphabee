...
create table if not exists aiphabee_core.partner_support_release_gate (
...
create table if not exists aiphabee_audit.partner_support_drill_event (
...
create table if not exists aiphabee_governance.partner_support_release_gate_contract (
