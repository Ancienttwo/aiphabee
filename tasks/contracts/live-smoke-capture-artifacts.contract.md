...
This task is complete when the capture contract is executable and wired into
`npm run check`. It does not claim live smoke output has been captured or that
