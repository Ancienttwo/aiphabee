...
- Added later `resolve_security`, `get_security_profile`,
  `get_market_calendar`, and `get_quote_snapshot` tool scaffolds and marked
  them as handler-ready registry entries.
