/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc apps/worker/src/worker-configuration.d.ts` (hash: 5d5ae311502cecb9c4fe7e8f72f344c0)
// Runtime types generated with workerd@1.20260617.1 2026-06-20 nodejs_compat
interface __BaseEnv_Env {
	AIPHABEE_HYPERDRIVE: Hyperdrive;
	HYPERDRIVE?: Hyperdrive;
	AIPHABEE_RESEARCH_AGENT_CONTROL_HYPERDRIVE?: Hyperdrive;
	APP_ENV: "staging" | "prod";
	APP_VERSION: "0.0.0";
	AIPHABEE_ARTIFACTS?: R2Bucket;
}
