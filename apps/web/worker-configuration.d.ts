/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging` (hash: ed63c26f95b8b5c7c7c942e60fa78455)
// Runtime types generated with workerd@1.20260617.1 2026-06-17 nodejs_compat
interface __BaseEnv_Env {
	AIPHABEE_AUTH_HYPERDRIVE: Hyperdrive;
	APP_ENV: "staging";
	BETTER_AUTH_URL: "https://aiphabee-web-staging.metalabs.workers.dev";
	GITHUB_CLIENT_ID: "Ov23li4RDf41KAk1K6la";
	AIPHABEE_AUTH_INVITED_EMAIL_SHA256: string;
	BETTER_AUTH_SECRET: string;
	GITHUB_CLIENT_SECRET: string;
	AIPHABEE_API: Service /* entrypoint AuthenticatedNetquityResolver from aiphabee-worker-staging */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "BETTER_AUTH_URL" | "GITHUB_CLIENT_ID" | "AIPHABEE_AUTH_INVITED_EMAIL_SHA256" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_SECRET">> {}
}
