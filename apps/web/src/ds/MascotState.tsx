 ...
 * error / onboarding states. Centered pose + title + description + optional
 * action, framed by an optional faint honeycomb backdrop.
 */

export type MascotStatePose =
  | "empty"
  | "success"
  | "risk"
  | "thinking"
...
export interface MascotStateProps extends Omit<HTMLAttributes<HTMLDivElement>, "title"> {
