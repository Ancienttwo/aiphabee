...
/**
 * AiphaBee Badge — the product's signal pill. Tones map to the data-viz
 * semantic tokens (sentiment, demand, status). `soft` (tinted) by default.
 */
...
const TONES: Record<
  BadgeTone,
  { c: string; solid: string; on: string; soft: string }
> = {
...
const PAD: Record<BadgeSize, { padding: string; fontSize: string }> = {
