# PRD: HKEX News data-ingest 每日抓取管线

> **Status**: Draft
> **Slug**: data-ingest
> **Created**: 2026-06-25 01:56
> **Updated**: 2026-07-02
> **Source Spec**: `docs/spec.md`
> **Tier**: compact

<!-- 2026-07-02 补注:本文件原为无头的架构问答记录(Mac mini + Codex Automation + data-ingest CLI + Scrapy 方案),按 PRD 命名规范补齐 header;正文保持原样。 -->
